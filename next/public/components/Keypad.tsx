...
function Button({ children, onClick }: { children: any, onClick: (e: PointerEvent) => void }) {
  return (<button className="p-3 border-1 block col-span-2 active:bg-gray-800 transition-colors duration-100 nth-[12]:col-span-3 nth-[13]:col-span-3" onClick={onClick}>{children}</button>
  )
}
